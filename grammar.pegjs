...
command_primary
  ...
  / name:([a-zA-Z][a-zA-Z0-9]*) [ \n\t]* ":=" [ \n\t]* "protect" [ \n\t]* "(" [ \n\t]* e:expr [ \n\t]* ")" { return { type: "protect", name: name.join(""), expr: e } }
  / name:([a-zA-Z][a-zA-Z0-9]*) [ \n\t]* ":=" [ \n\t]* "*"[ \n\t]* e:expr { return { type: "ptr-read", name: name.join(""), expr: e } }
  / name:([a-zA-Z][a-zA-Z0-9]*) [ \n\t]* ":=" [ \n\t]* arr:([a-zA-Z][a-zA-Z0-9]*) [ \n\t]* "[" [ \n\t]* e2:expr [ \n\t]* "]" { return { type: "arr-read", name: name.join(""), arr: arr.join(""), index:e2 } }
  / name:([a-zA-Z][a-zA-Z0-9]*) [ \n\t]* ":=" [ \n\t]* e:expr { return { type: "asgn", name: name.join(""), expr: e } }
